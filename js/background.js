...
// visibilityChangeEvent (在 main.js 中定义)
...
let ditheringTexture = createTextureAsync('assets/background.png', true);
...
document.addEventListener("mousedown", e => {
	if (typeof switchPage !== 'undefined' && switchPage.switched) {
		return
	}
